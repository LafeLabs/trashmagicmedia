...
document.getElementById("mapuserlink").href = "mathuser.php?map=" + currentFile;
...
if (this.readyState == 4 && this.status == 200) {
    ...
    for(var index = maps.length - 1;index >= 0;index--) {
